...
The class diagram below illustrates the structure of the undo/redo mechanism:

<puml src="diagrams/UndoRedoClassDiagram.puml" alt="Class Diagram for Undo/Redo Feature" />
